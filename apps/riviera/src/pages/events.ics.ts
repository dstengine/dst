...
const SITE = "https://riviera.dst.llc";
...
export const GET: APIRoute = () => {
  ...
  const body = toIcsCalendar(items, (item) => `${SITE}/events/${item.slug}/`, {
    name: "Azizi Riviera — what's on",
    description: "Resident meetups and promenade openings at Azizi Riviera, not a citywide calendar.",
    url: `${SITE}/events/`,
