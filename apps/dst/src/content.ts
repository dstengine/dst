 ...
 */
export const feed = {
  title: "DST — Dubai tech, crypto and property",
  description: "What changed in Dubai tech, crypto and property, each entry checked against the source that reported it.",
