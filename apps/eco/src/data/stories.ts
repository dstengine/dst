...
export interface Story {
  ...
  title: string;
  species?: string;
  /** Latin binomial, where the species is known precisely enough to name one. */
  binomial?: string;
  plantedBy?: string;
  location?: { name: string; mapUrl?: string; lat?: number; lng?: number };
  photo?: string;
  photoAlt?: string;
...
export const stories: Story[] = [
  {
    ...
    gallery: [
      {
        src: "/stories/douglas-fir-shilovka-04.jpg",
        alt: "The planting site — several saplings set out across a forest clearing near the Shaytanka river.",
      },
      {
        src: "/stories/douglas-fir-shilovka-02.jpg",
        alt: "One of the saplings looking dry after transport, wrapped in cut pine boughs for protection.",
      },
      {
        src: "/stories/douglas-fir-shilovka-03.jpg",
        alt: "A sapling showing green, living growth despite the dry appearance of the transport period.",
      },
    ],
    body: [
