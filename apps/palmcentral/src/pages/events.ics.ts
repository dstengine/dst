...
const SITE = "https://palmcentral.dst.llc";
...
export const GET: APIRoute = () => {
  ...
  const body = toIcsCalendar(items, (item) => `${SITE}/events/${item.slug}/`, {
    name: "Palm Central — what's on",
    description: "What is happening around Palm Central, each entry dated against its organiser.",
    url: `${SITE}/events/`,
