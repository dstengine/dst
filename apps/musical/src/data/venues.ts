...
export const venues: Venue[] = [
  {
    ...
    imageAlt:
      "The Ambassador Theatre on West 49th Street, its marquee and the Chicago banners down its brick flank, with Times Square beyond.",
    imageCredit: "Epicgenius",
    imageLicense: "CC BY-SA 4.0",
    imageLicenseSlug: "licence-cc-by-sa-4-0",
    imageSourceSlug: "photo-ambassador-theatre",
  ...
  },
  {
    ...
    city: "tokyo",
    image: "/venues/tokyu-theatre-orb.jpg",
    imageAlt:
      "The stair up into Tokyu Theatre Orb inside Shibuya Hikarie, its slatted timber walls funnelling towards the posters at the top.",
    imageCredit: "Dick Thomas Johnson",
    imageLicense: "CC BY 2.0",
    imageLicenseSlug: "licence-cc-by-2-0",
    imageSourceSlug: "photo-tokyu-theatre-orb",
