...
export const runs: Run[] = [
  {
    ...
    start: "1996-11-14",
    openRun: true,
    sellers: [{ slug: "tickets-chicago-new-york", name: "Telecharge", official: true }],
    summary:
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-dubai-ticketmaster", name: "Ticketmaster AE" }],
    summary:
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-tokyo", name: "Kyodo Tokyo", official: true }],
    summary:
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-plymouth", name: "Theatre Royal Plymouth" }],
  },
  {
    slug: "cardiff",
    show: "chicago",
    ...
    sellers: [{ slug: "tickets-chicago-cardiff", name: "Wales Millennium Centre" }],
  },
  {
    slug: "sheffield",
    show: "chicago",
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-newcastle", name: "Newcastle Theatre Royal" }],
  },
  {
    slug: "bournemouth",
    show: "chicago",
    ...
    sellers: [{ slug: "tickets-chicago-bournemouth", name: "Bournemouth Pavilion" }],
  },
  {
    slug: "glasgow",
    show: "chicago",
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-aberdeen", name: "Aberdeen Performing Arts" }],
  },
  {
    slug: "manchester",
    show: "chicago",
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-blackpool", name: "Winter Gardens Blackpool" }],
  },
  {
    slug: "nottingham",
    show: "chicago",
    ...
    sellers: [{ slug: "tickets-chicago-nottingham", name: "Royal Concert Hall Nottingham" }],
  },
  {
    slug: "bradford",
    show: "chicago",
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-eastbourne", name: "Trafalgar Tickets" }],
  },
  {
    slug: "birmingham",
    show: "chicago",
    ...
    sellers: [{ slug: "tickets-chicago-birmingham", name: "Birmingham Hippodrome" }],
    summary:
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-belfast", name: "Grand Opera House Belfast" }],
  },
  {
    slug: "bristol",
    show: "chicago",
  ...
  },
  {
    ...
    sellers: [{ slug: "tickets-chicago-cheltenham", name: "Everyman Theatre Cheltenham" }],
  },
  {
    slug: "stoke",
    show: "chicago",
  ...
  // stop is left without one.
  {
    ...
    sellers: [{ slug: "tickets-cats-plymouth", name: "Theatre Royal Plymouth", official: true }],
  },
  {
    slug: "hull",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-hull", name: "Hull Theatres", official: true }],
  },
  {
    slug: "birmingham",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-birmingham", name: "Birmingham Hippodrome", official: true }],
  },
  {
    slug: "manchester",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-manchester", name: "ATG Tickets", official: true }],
  },
  {
    slug: "bristol",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-bristol", name: "ATG Tickets", official: true }],
  },
  {
    slug: "llandudno",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-llandudno", name: "Venue Cymru", official: true }],
  },
  {
    slug: "glasgow",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-glasgow", name: "ATG Tickets", official: true }],
  },
  {
    slug: "nottingham",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-nottingham", name: "Royal Concert Hall", official: true }],
  },
  {
    slug: "canterbury",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-canterbury", name: "Marlowe Theatre", official: true }],
  },
  {
    slug: "sunderland",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-sunderland", name: "ATG Tickets", official: true }],
  },
  {
    slug: "aberdeen",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-aberdeen", name: "Aberdeen Performing Arts", official: true }],
  },
  {
    slug: "norwich",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-norwich", name: "Norwich Theatre", official: true }],
  },
  {
    slug: "belfast",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-belfast", name: "Grand Opera House", official: true }],
  },
  {
    slug: "dublin",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-dublin", name: "Bord Gáis Energy Theatre", official: true }],
  },
  {
    slug: "oxford",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-oxford", name: "ATG Tickets", official: true }],
  },
  {
    slug: "southampton",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-southampton", name: "Mayflower Theatre", official: true }],
  },
  {
    slug: "edinburgh",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-edinburgh", name: "ATG Tickets", official: true }],
  },
  {
    slug: "bradford",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-bradford", name: "Bradford Theatres", official: true }],
  },
  {
    slug: "liverpool",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-liverpool", name: "ATG Tickets", official: true }],
  },
  {
    slug: "woking",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-woking", name: "ATG Tickets", official: true }],
  },
  {
    slug: "cardiff",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-cardiff", name: "Wales Millennium Centre", official: true }],
  },
  {
    slug: "milton-keynes",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-milton-keynes", name: "ATG Tickets", official: true }],
  },
  {
    slug: "newcastle",
    show: "cats",
    ...
    sellers: [{ slug: "tickets-cats-newcastle", name: "Theatre Royal Newcastle", official: true }],
  },
];
