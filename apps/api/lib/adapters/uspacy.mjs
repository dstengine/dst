// Forwards a lead to Uspacy.com's inbound webhook. Same shape as the
// Telegram/Planfix adapters: one function, POSTs the lead unchanged, fails
// cleanly (never throws) when unconfigured.
