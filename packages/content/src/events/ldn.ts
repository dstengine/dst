...
export const items: EventItem[] = [
...

  {
    ...
    body: [
      ...
      "Festival director Kristy Matheson, announcing it on 29 July: &laquo;Anchored by Andrew Scott&rsquo;s astounding central performance, few films will leave a lasting imprint on audiences this year quite like Elsinore.&raquo;",
      ...
      "The programme lands a fortnight before anything can be bought. That gap is the festival handing every buyer the same information and then making them wait &mdash; and the people who spend it building a shortlist are the ones who get the screenings they wanted.",
    ...
    programme: [
      { heading: "7&ndash;18 October &mdash; the festival", text: "Twelve days, opening at the Royal Festival Hall with <strong>Elsinore</strong>." },
      { heading: "2 September &mdash; the full programme", text: "The date the BFI gave for publishing everything that plays. <span class=\"tba\">To be announced</span>" },
      { heading: "17 September &mdash; tickets", text: "General sale, with BFI Members booking before it. Prices <span class=\"tba\">to be announced</span>" },
      { heading: "During September &mdash; the other shortlists", text: "Documentary, First Feature and Short Film. Titles <span class=\"tba\">to be announced</span>" },
      { heading: "18 October &mdash; the awards", text: "The LFF Awards Jury names the Best Film winner on the closing day." },
    ],
    expertise:
