...
export const items: NewsItem[] = [
...

  {
    ...
    body: [
      "El Zócalo se llena solo y hay que llegar cinco horas antes. Las alcaldías son la otra manera de pasar la noche del Grito, y Miguel Hidalgo ya publicó su cartel con horarios.",
      "## Dónde y a qué hora",
      "En la <strong>explanada de la Alcaldía Miguel Hidalgo</strong>, <strong>Av. Parque Lira 94</strong>, colonia Observatorio, el <strong>martes 15 de septiembre de 2026</strong>. Las actividades arrancan desde las <strong>15:00</strong> y los conciertos van de las <strong>19:00</strong> en adelante. La entrada es <strong>gratuita</strong>.",
      "## El cartel, en orden",
      "<strong>19:00</strong> — Embajadores de la Cumbia Dinamita.<br />",
      "<strong>21:00</strong> — Los Yaguaru.<br />",
      "<strong>23:15</strong> — Paty Cantú.",
      "## Qué significa ese horario",
      "El acto principal entra <strong>después</strong> de la hora en que suena la campana, no antes. Es una decisión de programación, no un descuido: quien va por el Grito no se pierde el concierto, y quien va por el concierto no tiene que aguantar tres horas de espera para verlo.",
      "## Quién lo organiza",
      "La <strong>Alcaldía Miguel Hidalgo</strong>, que anunció el programa por sus redes oficiales e invitó a celebrar «junto a toda tu familia y amigos» en la explanada. El comunicado menciona más actividades sin detallarlas todavía.",
    ],
    expertise:
      "La diferencia práctica entre el Zócalo y una explanada de alcaldía no es el cartel, es la salida. Un evento de plancha con cientos de miles de personas cierra estaciones del Metro y convierte el regreso en la parte larga de la noche; una explanada de alcaldía se desahoga por calles normales y por Constituyentes, y a las 00:30 se puede caminar. Por eso el horario de las 23:15 funciona: en el Zócalo, un acto que termina pasada la medianoche te deja compitiendo con toda la plancha por el mismo andén. Si la idea es ir con niños, lo que sirve son las actividades desde las 15:00, no los conciertos — y conviene revisar las redes de la alcaldía en los días previos, porque el resto del programa aún no se publica.",
  },

  {
    ...
    imageWidth: 1536,
    imageHeight: 864,
    title: "Saturno tiene ahora un decágono, y lo dirigió un científico que publica en español",
    cardTitle: "Saturno tiene un decágono",
    titleSeo: "Hubble confirma un decágono en Saturno",
    summary:
      "El Hubble confirmó una onda de diez lados en el polo sur de Saturno. El estudio, del 2 de septiembre, lo encabeza Agustín Sánchez-Lavega, de la Universidad del País Vasco.",
    date: "2026-09-05",
    category: "Ciencia",
    source: {
      name: "NASA Science",
    ...
    body: [
      "Un planeta hecho de gas no debería tener esquinas. Saturno lleva cuarenta años con un hexágono en el polo norte y acaba de estrenar diez lados en el sur.",
      "## Qué se confirmó",
      "El <strong>telescopio espacial Hubble</strong> confirmó una <strong>onda atmosférica de diez lados</strong> alrededor del <strong>polo sur de Saturno</strong>: la primera vez que se ve un patrón poligonal grande en el hemisferio sur del planeta. El trabajo se publicó el <strong>2 de septiembre de 2026</strong> en <em>Science Advances</em> y lo encabeza <strong>Agustín Sánchez-Lavega</strong>, de la <strong>Universidad del País Vasco</strong>.",
      "## Cómo se llegó a él",
      "Al revés de como suena. En imágenes del Hubble de <strong>2023</strong> ya había rastros de una figura de diez vértices que nadie estaba buscando. En <strong>2024</strong>, Sánchez-Lavega y los astrónomos aficionados <strong>Trevor Barry</strong> y <strong>Jean-Paul Oger</strong> notaron desde tierra una banda ondulada en el polo sur. Para <strong>agosto y septiembre de 2025</strong> el decágono ya se veía completo.",
      "## No es el gemelo del hexágono",
      "El hexágono del norte aparece cada vez que alguien lo busca desde hace <strong>más de cuarenta años</strong> y casi no cambia. El del sur sí. <strong>Amy Simon</strong>, del Centro Goddard de la NASA e investigadora principal del programa OPAL: «Nunca habíamos visto algo así en el hemisferio sur de Saturno. Esta estructura es distinta: parece estar fortaleciéndose».",
      "## Qué es en realidad",
      "Una onda estacionaria dentro de una corriente en chorro polar: viento muy rápido en anillo que, al perturbarse, se acomoda en un número entero de lóbulos. Diez lóbulos, diez lados rectos. Atraviesa varias capas de la atmósfera, así que no es un dibujo en las nubes: es un patrón en el viento y las nubes solo lo revelan.",
    ],
    expertise:
      "Vale la pena separar dos cosas que la nota suele mezclar. El hallazgo no es que Saturno «forme figuras» — eso ya se sabía por el hexágono — sino que se atrapó una en pleno crecimiento, y esa es la parte que no se pudo hacer con la del norte, descubierta cuando ya llevaba tiempo instalada. La pregunta que deja abierta Simon, por qué aparece ahora, tiene una respuesta candidata poco espectacular: el año de Saturno dura casi treinta años terrestres, y el polo sur no lleva observándose con cuidado ni un ciclo completo. Para quien mira desde la Tierra, el dato útil es otro: el patrón está en el polo, no en el ecuador, así que no se ve con un telescopio doméstico — lo que sí está al alcance de un aficionado, como demuestran Barry y Oger, es notar que algo cambió.",
  },

  {
    ...
    body: [
      ...
      "## Por qué en esa glorieta y no en otra",
      "La Glorieta de Insurgentes es una estación con techo de cielo: el cruce de la Línea 1 con el Metrobús, y una plaza hundida por la que se pasa aunque uno no vaya a nada. Programar ahí significa que el público no tiene que decidir asistir — le toca de paso.",
      "## El detalle institucional",
      "La organización corre por cuenta del propio <strong>Metro de la Ciudad de México</strong>, bajo la dirección de <strong>Adrián Rubalcava</strong>, con el lema <strong>#57AñosEnMovimiento</strong>.",
    ],
    expertise:
      "Un cartel gratuito de cuatro días en una glorieta de paso se comporta distinto a un festival con boleto: no hay aforo que administre la entrada, así que la hora hace todo el trabajo. Los horarios publicados — de 11:00 a 16:00 el jueves, 13:40 el viernes — caen en horario laboral entre semana, que es justamente cuando la glorieta está más vacía y el sonido se escucha mejor. El sábado, con siete actos y sin nadie que tenga que volver a la oficina, es el día en que conviene llegar temprano. Y conviene revisar el orden de presentación el mismo día: en eventos gratuitos de calle los horarios se recorren con más facilidad que en un recinto cerrado.",
  },

  {
    ...
    imageWidth: 1536,
    imageHeight: 864,
    title: "Apple cambió de director general y en México no cambia nada — todavía",
    cardTitle: "Apple cambia de director general",
    titleSeo: "Apple: John Ternus sustituye a Tim Cook",
    summary:
      "John Ternus asumió el 1 de septiembre. La empresa opera en más de 200 países y territorios, así que la decisión llega a todos los mercados el mismo día, incluido este.",
    date: "2026-09-01",
    category: "Tecnología",
    source: {
      name: "Apple Newsroom",
    ...
    body: [
      "Hay decisiones corporativas que ocurren en un país y tardan años en notarse en el resto. Esta no: Apple vende en <strong>más de 200 países y territorios</strong>, y el <strong>1 de septiembre de 2026</strong> todos ellos amanecieron con un director general distinto.",
      "## Qué pasó exactamente",
      "<strong>John Ternus</strong> es el nuevo director ejecutivo de Apple. <strong>Tim Cook</strong>, que ocupó el cargo durante quince años, pasó a ser <strong>presidente ejecutivo</strong> del consejo, con una función que la propia empresa describe como el trato con reguladores y autoridades de todo el mundo. <strong>Arthur Levinson</strong>, presidente del consejo durante los últimos quince años, quedó como consejero independiente principal.",
      "El cambio se anunció el <strong>20 de abril</strong> y se ejecutó en la fecha prometida.",
      "## La escala de lo que cambia de manos",
      "Bajo Cook, el valor de mercado de Apple pasó de unos <strong>350 mil millones de dólares</strong> a cerca de <strong>4 billones</strong>. Los ingresos subieron de <strong>108 mil millones</strong> en el año fiscal 2011 a <strong>416 mil millones</strong> en 2025. La división de servicios superó por sí sola los <strong>100 mil millones</strong>. Hay más de <strong>2 500 millones</strong> de dispositivos activos en uso.",
      "## Por qué importa desde aquí",
      "Para quien compre un teléfono esta semana, nada. El precio, la garantía y las tiendas siguen igual, y esa continuidad es precisamente el motivo por el que se eligió a alguien de dentro: Ternus entró a la empresa en <strong>2001</strong> y dirigía la <strong>ingeniería de hardware</strong> — el iPhone, el iPad, la Mac, el Apple Watch y los AirPods físicos.",
      ...
      "En el mismo balance aparece que la huella de carbono de Apple está <strong>60% por debajo de los niveles de 2015</strong>. Es una reducción absoluta, no por unidad, lograda mientras los ingresos se cuadruplicaban. De todas las cifras del recuento, es la única que se volvía más difícil cada año que las demás crecían.",
    ],
    expertise:
      "Al leer cualquier relevo directivo, la pregunta útil no es quién entra sino <strong>qué se quedó el que sale</strong>. Aquí Cook conserva un papel con límites escritos — reguladores y autoridades — y no una asesoría difusa. Cuando el saliente se queda sin funciones definidas, en la práctica sigue mandando y nadie sabe a quién preguntarle.",
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "## Las cifras",
      "Ecobici pasa de <strong>9 308 a 15 000 bicicletas</strong> — un aumento de alrededor del <strong>60%</strong> — y de <strong>687 a 1 111 cicloestaciones</strong>, es decir <strong>424 nuevas</strong>. La transformación arranca en <strong>septiembre de 2026</strong>",
  ...
  },
  {
    ...
    body: [
      "La cifra que importa no es <strong>8.86 segundos</strong>. Es <strong>21.50</strong> — lo que el mismo robot tardaba hace <strong>doce meses</strong>",
      ...
      "Robots que tropezaron, que se rompieron y alguno que se incendió. Y el reproche que se repitió en la cobertura: corren rapidísimo y todavía no saben conectar un cable. La destreza fina — agarrar, orientar, insertar — sigue siendo mucho más difícil que correr en línea recta",
    ],
    expertise:
  ...
  },
  {
    ...
    expertise:
      "La captación de lluvia sólo rinde en temporada, que en la ciudad va de junio a octubre. Los 60 mil litros son un máximo estacional, no un promedio anual, y el sistema alimenta sanitarios administrativos, no todo el recinto. Es una cifra real y acotada — que es más de lo que suele decirse en un anuncio de este tipo.",
  },
  {
    ...
    body: [
      "Las autoridades capitalinas programaron el cierre por mantenimiento de <strong>quince estaciones del Metrobús</strong> repartidas entre las líneas 2, 3 y 5. Los trabajos son de <strong>guías táctiles y cortinas</strong> — es decir, la franja con relieve que permite a una persona ciega caminar por el andén, y las puertas del propio andén.",
      ...
      "## Líneas 2 y 5",
      "La <strong>línea 2</strong>, de Tacubaya a Tepalcates, cerró Amores el 15 y 16 de agosto, Doctor Vértiz el 22 y 23, Centro SCOP el 29 y 30, y le queda <strong>UPIICSA el 5 y 6 de septiembre</strong> — la única pendiente de esa línea.",
      ...
      "Lo que se repone es, en los dos casos, infraestructura de accesibilidad. Es la clase de obra que sólo nota quien la necesita — y que, mientras dura, es justamente quien más resiente la estación cerrada.",
    ],
    expertise:
  ...
  },
  {
    ...
    body: [
      ...
      "En paralelo van la limpieza, el mantenimiento y la <strong>restitución de piezas de piedra bola y adoquín</strong> — es decir, reponer lo que ya había, pieza por pieza, en vez de sustituir el piso.",
      ...
      "El proyecto junta dos bolsas. Una es la obra que hace directamente la demarcación — vegetación, limpieza, piedra. La otra es <strong>Presupuesto Participativo</strong>, recursos votados y avalados por la comunidad vecinal, destinados al cuidado de las jardineras.",
  ...
  },
  {
    ...
    body: [
      ...
      "<strong>«Porque ahora pienso en ti, más que ayer, mucho más»</strong> abrió el <strong>sábado 29 de agosto a las 12 horas</strong>, en Isabel La Católica 26, Centro Histórico. Se conmemora el <strong>aniversario 16</strong> del fallecimiento del escritor.",
      "## El título es de Juan Gabriel",
      "La frase viene de «Hasta que te conocí». Romero la eligió porque, dice, en estos momentos — junto con el entusiasmo que hubo en las calles durante el Mundial y la polémica de la inteligencia artificial — ha pensado en Monsiváis.",
      ...
      "<strong>La sala de la lupa feroz</strong> aborda a Monsiváis como memorista, buscador de «lo desaparecido, lo minúsculo y lo invisible»: una instalación de lupas con imágenes grabadas que se proyectan sobre libros del autor, en pasajes que las referencian.",
