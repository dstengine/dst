...
export const items: NewsItem[] = [
  {
    ...
    imageWidth: 1536,
    imageHeight: 864,
    title: "Six aging clocks agreed about an AI-designed drug, and the people who ran them say that is not enough",
    cardTitle: "Six clocks, one AI-designed drug",
    titleSeo: "Rentosertib: what six aging clocks measured",
    summary:
    ...
    body: [
      "A clinical trial measures whether a drug helps with the illness it was given for. It does not normally ask whether the patient aged more slowly while taking it, because there is no agreed way to ask. A paper published in <strong>Nature Biotechnology</strong> on <strong>7 September 2026</strong> asked anyway, on blood already drawn for another purpose, and reports that six separate models all answered the same way.",
      "The drug is <strong>rentosertib</strong>, formerly INS018_055. Its target, a kinase called <strong>TNIK</strong>, was picked out of the literature by software; the molecule was generated by software as well. It is developed by <strong>Insilico Medicine</strong>, whose first-listed address on this paper is in <strong>Abu Dhabi</strong>, with further offices in Shanghai and Cambridge, Massachusetts.",
      "## What was actually measured",
      "The trial itself was a phase 2a study in <strong>idiopathic pulmonary fibrosis</strong>, run across 21 sites in China in 2023 and 2024. Of 71 patients randomised, <strong>42</strong> agreed to have their serum proteins read as well, at the start and at weeks 2, 4 and 12. That reading covered <strong>2,841 proteins</strong> per sample.",
      ...
      "They converged. Every treated group came out younger than it started; the placebo group did not move, or drifted slightly older. At week 4, the four calendar-age clocks put the 60 mg once-daily group between <strong>2.7 and 3.5 years</strong> below its own baseline. Across the whole design, 21 of the comparisons cleared the significance threshold where chance alone predicted 0.15 of them.",
      "## The finding the authors keep returning to",
      "The dose that worked best on the lungs was not the dose that moved the clocks. <strong>60 mg once daily</strong> produced the largest gain in lung capacity in the original trial report; <strong>30 mg twice daily</strong>, the same total per day in two smaller pieces, produced the broader and more consistent aging signal. Lung-function change explained almost none of the variation in biological age — a median of 6% across the six models.",
